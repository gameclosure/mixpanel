...
//GC: @interface Mixpanel () <UIAlertViewDelegate, MPSurveyNavigationControllerDelegate> {
...
//GC: @property (nonatomic, strong) MPSurvey *currentlyShowingSurvey;
...
//GC:@property (nonatomic, weak) Mixpanel *mixpanel;
@property (nonatomic, unsafe_unretained) Mixpanel *mixpanel;
