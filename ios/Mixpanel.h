 ...
 */
//GC:@property (atomic, weak) id<MixpanelDelegate> delegate; // allows fine grain control over uploading (optional)
@property (atomic, unsafe_unretained) id<MixpanelDelegate> delegate; // allows fine grain control over uploading (optional)
